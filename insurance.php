					...
					<div class="row align-items-center c-gutter-85">
						...
						<div class="col-xl-4 col-lg-5 col-md-5 col-12">
							<div class="contact-item animate" data-animation="scaleAppear">
								<h3 class="special-heading">Insurance<span class="text-gradient">Registration</span></h3>
								<div class="divider-35"></div>
								<form class=" c-mb-30 c-gutter-20" method="post" action="insurance.php">
									<div class="row">
										<div class="col-sm-12">
											<div class="has-placeholder">
												<label for="name">Insurance Company Name </label>
												<input type="text" aria-required="true" size="30" value="" name="company_name" id="name"  placeholder="Insurance Company Name">
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="has-placeholder textarea">
												...
												<input type="file" aria-required="true" size="30" value="" name="image" id="image"  placeholder="Company Image">
											</div>
										</div>
									</div>
									<div class="row">
                                    ...
                                    <div class="row">
										<div class="col-sm-12">
											<div class="form-group has-placeholder textarea">
												...
												<input type="hidden"  size="30" value="" name="role" value = "insurance" id="role">
											</div>
										</div>
									</div>
									<div class="row">
...
$query = "INSERT INTO `user`(`user_name`, `email`, `address`,`city`,`lat`,`lng`, `password`,`confirm_password`, `phone_no`, `image`,`description`, `role`) VALUES ('$company_name','$email','$address','$city','$latitude','$longitude','$user_password', '$user_password_Confirm','$mobile','$image','$description','$role')";
