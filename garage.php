						...
						<main class="col-lg-12">
							<article>
								<header class="entry-header mb-30">
									<h1 class="entry-title">Garage Registration</h1>
									...
									<div class="woocommerce">
											...
											<form  method="post" action="garage.php">
												...
												<p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
													...
													<input type="text" class="form-control woocommerce-Input woocommerce-Input--text input-text" name="name" id="name" placeholder="Name">
												</p>

												<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													<label for="account_email">Email address <span class="required">*</span>
													</label>
													<input type="email" class="form-control woocommerce-Input woocommerce-Input--email input-text" name="email" id="account_email" placeholder="username@gmail.com">
												</p>
                                                ...
                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													...
													<input type="textarea" class="form-control woocommerce-Input woocommerce-Input--address input-text" name="address" id="address" placeholder="Address">
												</p>
                                                ...
                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													...
													<input type="file" class="form-control woocommerce-Input woocommerce-Input--phone input-file" name="image" id="image" placeholder="Garage Image">
                                                </p>
...
$query = "INSERT INTO `garage`(`garage_name`, `email`, `address`, `password`, `phone_no`, `description`, `garage_image`) VALUES ('$name','$email','$address','$user_password','$mobile','$description','$image')";
