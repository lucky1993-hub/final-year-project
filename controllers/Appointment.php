...
class Trips extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->template_render('appointment_management',$data);
	}
	public function addtrips()
	{
		$data['customerlist'] = $this->trips_model->getall_customer();
		$data['vechiclelist'] = $this->trips_model->getall_vechicle();
		$data['mechaniclist'] = $this->trips_model->getall_mechaniclist();
		$this->template->template_render('appointent_add',$data);
	}
	public function inserttrips() 
	{
		...
		if($testxss){
			...
			if($response) {
				$this->session->set_flashdata('successmessage', 'New Appointment added successfully..');
			} else {
