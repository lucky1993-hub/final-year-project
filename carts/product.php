				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							<h6 class="product-name">'.$row['product_title'].'</h6>
							<div>
							...
							<div>
								<h3 class="product-price">Rs.'.$row['product_price'].'<del class="product-old-price">Rs.9900.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>A high-quality car escape tool,Double-sided, steel hammer heads,Includes a mounting bracket,A fluorescent pin glows in the dark</p>
