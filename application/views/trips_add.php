       ...
       <form method="post" id="trip_add" class="card"  action="<?php echo base_url();?>Trips/<?php echo (isset($tripdetails))?'updatetrips':'inserttrips'; ?>">
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Mechanic<span class="form-required">*</span></label>
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Service Type<span class="form-required">*</span></label>
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     ...
                     <input type="text" value="<?php echo (isset($tripdetails)) ? $tripdetails[0]['t_trip_fromlocation']:'' ?>" name="t_trip_fromlocation" id="t_trip_fromlocation" class="form-control" placeholder="Start Location">
                  </div>
               </div>
              <!-- <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">End Location<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($tripdetails)) ? $tripdetails[0]['t_trip_tolocation']:'' ?>" name="t_trip_tolocation" id="t_trip_tolocation" class="form-control" placeholder="End Location">
                  </div>
               </div>
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
               ...
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">Appointment Date<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($tripdetails)) ? $tripdetails[0]['t_start_date']:'' ?>" name="t_start_date" value="" class="form-control datepicker" placeholder="Appointment Date">
                  </div>
               </div>
               <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                     <label class="form-label">End Date<span class="form-required">*</span></label>
                     <input type="text" value="<?php echo (isset($tripdetails)) ? $tripdetails[0]['t_end_date']:'' ?>" name="t_end_date" value="" class="form-control datepicker" placeholder="End Date">
                  </div>
               </div>
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
           ...
           <?php } ?>
            ...
            <div class="card-footer text-right">
               <button type="submit" class="btn btn-primary"> <?php echo (isset($tripdetails))?'Update Appointment':'Add Appointment' ?></button>
            </div>
      </form>
             </div>
    </section>
