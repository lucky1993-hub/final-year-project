    ...
    <nav class="navbar navbar-expand navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
         ...
         <li class="nav-item d-none d-sm-inline-block">
          <span class="nav-link"><b>Mechanic : </b><?= (isset($tripdetails['t_driver_details']->d_name))?$tripdetails['t_driver_details']->d_name:'<span class="badge badge-danger">Yet to Assign</span>'; ?></span>
        </li>
      </ul>
