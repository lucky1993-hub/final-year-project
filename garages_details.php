				...
				<section class="page_title ds s-pt-105 s-pb-50 s-pt-lg-115 s-pb-lg-60">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-12">
								<h1 class="bold text-center text-lg-left">Garages</h1>
								<ol class="breadcrumb">
									<li class="breadcrumb-item">
										<a href="index.php">Home</a>
									</li>
									<li class="breadcrumb-item">
										<a href="Registration.php">All Garages</a>
									</li>
							...
							<div class="columns-3">
								<form class="form-inline shop-form bordered mb-30">
									<p class="woocommerce-result-count fs-14 fw-400">
										<span class="color-dark fw-500 product-found fs-16">4</span>Gargaes Found
									</p>
								...
								<ul id="products" class="products list-unstyled grid-view">
									...
									<li class="product vertical-item padding-small content-padding">
                                        ...
                                        <a class="link-scale" href="signIn.php">
												<img src="images/team/<?php echo $row["garage_image"]; ?>" alt="">
											</a>
											<div class="item-content">
												<h5><?php echo $row["garage_name"];?></h5>
