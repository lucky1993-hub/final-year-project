										...
										<ul class="nav sf-menu">
											...
											<li class="active">
												<a href="Mechanic_details.php">Mechanic</a>
													...
													<!-- Insurance Copany -->
													<li>
														<a href="auto/admin/index.php">Sign In</a>
													</li>
				...
				<div class="container">
					<div class="row c-gutter-40">
						...
						<?php
		                                         ...
		                                         ON mechanic_schedule_table.mechanic_id = mechanic_table.mechanic_id 
                                                 WHERE mechanic_status = 'Active'
                                                 ORDER BY mechanic_added_on DESC ";
                                                  $result = mysqli_query($connect,$query);
                                                 if(mysqli_num_rows($result) > 0){

                                                     while($row = mysqli_fetch_array($result)){
                                                         $t_id    = $row['mechanic_id'];
								...
								<div class="row">
									<div class="col-xl-4 col-lg-5 col-md-5">
										<div class="item-media cover-image">
											<img src="images/<?php echo $row["mechanic_profile_image"]; ?>" alt="">
											<div class="media-links">
												<a class="abs-link" title="" href="booking.php?user_id=<?php echo  $t_id; ?>"></a>
											</div>
										</div>
									</div>
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										...
										<div class="item-content">
											<h6>
												<a href="event-single-left.html"><?php echo $row["mechanic_name"];?></a>
											</h6>

											<div class="mb-10 item-meta color-darkgrey">
												<span>
													<i class="fa fa-calendar color-main"></i> <span><?php echo $row["mechanic_added_on"];?></span>
												</span>
												<span>
													<i class="fa fa-clock-o color-main"></i> <span><?php echo $row["mechanic_schedule_start_time"]. ' - '.$row["mechanic_schedule_end_time"];?></span>
												</span>
											</div>
											<p>
												Times are changing…cars are changing. One of the biggest changes in today’s automotive industry is the perception of a “tune-up.” Ask 10 vehicle owners their definition of a tune-up and chances are there’ll be 10 different answers. 
											</p>
