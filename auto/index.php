		      					...
		      					<table class="table table-striped table-bordered">
		      						...
		      						foreach($result as $row)
		      						{
		      							...
		      							<tr>
		      								...
		      								<td>'.$row["mechanic_phone_no"].'</td>
		      								<td>'.$row["mechanic_schedule_day"].'</td>
		      								<td>'.$row["mechanic_schedule_start_time"].' - '.$row["mechanic_schedule_end_time"].'</td>
		      								<td><button type="button" name="get_appointment" class="btn btn-primary btn-sm get_appointment" data-id="'.$row["mechanic_schedule_id"].'">Get Job Card</button></td>
		      							</tr>
		      							';
		      						}
		      						?>
