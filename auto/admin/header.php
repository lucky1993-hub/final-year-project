    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">AutoMan</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="mechanic_schedule.php">
                    <i class="fas fa-user-clock"></i>
                    <span>Mechanic Schedule</span></a>
            </li>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="mechanic_profile.php">
                    <i class="far fa-id-card"></i>
                    <span>Profile</span></a>
            </li>
            <?php
     ...
     <li class="dropdown">
      ...
      <ul class="dropdown-menu"></ul>
                        ...
                        if($_SESSION['type'] == 'Mechanic')
                        {
                            ...
                            foreach($user_result as $row)
                            {
                                $user_name = $row['mechanic_name'];
                                $user_profile_image = $row['mechanic_profile_image'];
                            }
                        }
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="mechanic_profile.php">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <div class="dropdown-divider"></div>
