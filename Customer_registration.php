					...
					<div class="row align-items-center c-gutter-85">
						...
						<div class="col-xl-4 col-lg-5 col-md-5 col-12">
							<div class="contact-item animate" data-animation="scaleAppear">
								<h3 class="special-heading">Customer<span class="text-gradient">Registration</span></h3>
								<div class="divider-35"></div>
								<form class=" c-mb-30 c-gutter-20" method="post" action="Customer_registration.php">
									<div class="row">
										<div class="col-sm-12">
											<div class="has-placeholder">
												<label for="name">Customer Name </label>
												<input type="text" aria-required="true" size="30" value="" name="customer_name" id="name"  placeholder="Customer Name">
											</div>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="has-placeholder textarea">
												...
												<input type="file" aria-required="true" size="30" value="" name="image" id="image"  placeholder="Image">
											</div>
										</div>
									</div>
...
$query = "INSERT INTO `customer_table`(`customer_name`, `customer_email_address`, `customer_address`,`city`,`lat`,`lng`, `customer_password`, `customer_phone_no`, `customer_image`) VALUES ('$customer_name','$email','$address','$city','$latitude','$longitude','$user_password','$mobile','$image')";
