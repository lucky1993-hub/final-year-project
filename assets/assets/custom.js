  ...
  $.validator.setDefaults({
    ...
    $('#add_driver,#vehicle_add,#customer_add,#login,#trip_add,#Income_Expense,#fuel,#track,#geofencesave,#trippayments,.basicvalidation,#smtpconfigtestemail').validate({
        ...
        messages: {
            ...
            t_driver: {
                required: "Choose Mechanic",
            },
            t_type: {
                required: "Choose type of Problem",
            },
            t_trip_fromlocation: {
                required: "Select start location",
            },
            t_trip_tolocation: {
                required: "Select to/end location",
            },
            t_start_date: {
                required: "Select  start date",
            },
            t_end_date: {
                required: "Select  to/end date",
            },
            t_trip_amount: {
                required: "Booking amount/rent is required",
                number: "Please enter valid number",
            },
            geo_name:{
